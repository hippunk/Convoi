...
Test pour essayer d'avoir une turtle qui tourne autour d'une autre selon un range donné,
dans le but de pouvoir afficher les ranges des unités dans Convoi
